...
const Features = () => {
  return (
    <>
      ...
      <section className="mt-32 max-md:mt-10 text-center">
        ...
        <div className="w-[130%] max-md:w-[100%] relative m-auto -left-[15%] max-md:left-0 mt-10">
          <div className="absolute bg-gradient-to-r from-background -top-4 bottom-0 -left-10 max-md:-left-20 max-md:w-[55%] w-[20%] z-10 "></div>
          <div className="absolute bg-gradient-to-l from-background -top-4 bottom-0 -right-10 max-md:-right-20 max-md:w-[55%] w-[20%] z-10 "></div>
          <CoinRow />
        </div>
      </section>
      <section className="flex max-md:flex-col max-md:text-center justify-between items-center max-md:mt-2 mt-24">
