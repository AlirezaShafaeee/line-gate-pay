...
const Item = () => {
    return (
        <div className='flex flex-col items-center justify-center bg-card_shade px-[30px] py-[20px] rounded-[5%]'>
            ...
            <h4 className='text-[18px] font-[700] mt-[25px]'>White Label</h4>
            <div className='flex flex-col items-start justify-start mt-[7px]'>
                ...
                <div className='flex items-center justify-center'>
                    <div className='w-[8px] h-[8px] rounded-full bg-primary'></div>
                    <span span className='ml-[13px]'>No redirects to Plisio</span>
                </div>
                <div className='flex items-center justify-center'>
                    <div className='w-[8px] h-[8px] rounded-full bg-primary'></div>
                    <span span className='ml-[13px]'>Your own design</span>
                </div>
            </div>
        </div>
    );
