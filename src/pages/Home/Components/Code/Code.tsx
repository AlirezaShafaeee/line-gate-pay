        ...
        <div className='flex flex-col-reverse items-center justify-between max-w-[1280px] mx-auto sm:flex-row'>
            <div className='flex flex-col-reverse items-center sm:flex-row'>
                ...
                <div className='flex mt-[25px] mb-[10px] sm:mb-[0px] sm:mt-[0px] sm:space-y-7 text-[18px] font-[700] text-[#BABABA] sm:flex-col '>
                    <div onClick={() => setSelected(0)} className={['cursor-pointer flex items-center justify-start pl-[20px] ', selected===0? "text-primary sm:border-l-[5px] sm:border-primary sm:pl-[15px] " : ""].join(" ")}>
                        <div><FaRobot/></div>
                        <span className='ml-[5px]'>Balance</span>
                    </div>
                    <div onClick={() => setSelected(1)} className={['cursor-pointer flex items-center justify-start pl-[20px]', selected===1? "sm:border-l-[5px] sm:border-primary sm:pl-[15px] text-primary" : ""].join(" ")}>
                   
                        <div><PiBagFill/></div>
                        <span className='ml-[5px]'>Payout</span>
                    </div>
                    <div onClick={() => setSelected(2)} className={['cursor-pointer flex items-center justify-start pl-[20px]', selected===2? "sm:border-l-[5px] sm:border-primary sm:pl-[15px] text-primary" : ""].join(" ")}>
            ...
            <div className='flex flex-col items-center w-[90%] sm:w-[30%] sm:items-start'>
                ...
                <span className='mt-[10px] mb-[25px] text-center sm:text-start'>Use our code to connect your business in a few clicks. Our API will show you that managing your funds and invoices or calculating fees has never been easier.</span>
